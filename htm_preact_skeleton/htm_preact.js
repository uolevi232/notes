// combined htm+preact from https://unpkg.com/htm@3.1.1/preact/standalone.module.js
// update as needed idc
var e,
  n,
  _,
  t,
  ...
  for (_.__k = [], a = 0; a < n.length; a++)
    if (
      ...
      if (
        ((m.__ = _),
        (m.__b = _.__b + 1),
        null === (y = H[a]) || (y && m.key == y.key && m.type === y.type))
      )
        H[a] = void 0;
      else
        for (d = 0; d < E; d++) {
      ...
      P(e, m, (y = y || l), o, r, u, c, s, f),
        ...
        null != g
          ? (null == k && (k = g),
            "function" == typeof m.type && null != m.__k && m.__k === y.__k
              ? (m.__d = s = b(m, s, e))
              : (s = C(e, m, y, H, g, s)),
            f || "option" !== _.type
...
function w(n, _, t, o, r, u, i, c) {
  ...
  if (("svg" === y && (r = !0), null != u))
    for (; m < u.length; m++)
      if ((s = u[m]) && (s === n || (y ? s.localName == y : 3 == s.nodeType))) {
        (n = s), (u[m] = null);
        break;
      }
  if (null == n) {
  ...
  if (null === y) h === d || (c && n.data === d) || (n.data = d);
    ...
    if (
      ...
      (p || a) &&
        ((p && ((a && p.__html == a.__html) || p.__html === n.innerHTML)) ||
    ...
    if (
      ((function (e, n, _, t, o) {
        var r;
        for (r in _)
          "children" === r || "key" === r || r in n || H(e, r, null, _[r], t);
        for (r in n)
...
function M(_, t, o) {
  ...
  n.__ && n.__(_, t),
    ...
    P(
      ...
      !r && o ? [o] : u ? null : t.firstChild ? e.call(t.childNodes) : null,
      i,
          ...
          try {
            if (
              ((t = _.constructor) &&
                ...
                (_.setState(t.getDerivedStateFromError(e)), (o = _.__d)),
      ...
      ((1 !== I.push(_) && W === n.requestAnimationFrame) ||
        (
          ...
          function (e) {
            var n,
              _ = function () {
                clearTimeout(t), oe && cancelAnimationFrame(n), setTimeout(e);
              },
              t = setTimeout(_, 100);
